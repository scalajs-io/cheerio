...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.scalajs.npm" %%% "htmlparser2" % "3.9.2-3"
  ))
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/cheerio.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/cheerio.git</developerConnection>
        <url>github.com/scalajs-io/cheerio.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
